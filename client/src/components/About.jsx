...
const About = () => {
  ...
  const referralLink = "https://www.skool.com/cybersec/about?ref=4660ce640b4f4867bd5433a0ddf6be74";
      ...
      {showInviteModal && (
        <div className="fixed inset-0  bg-opacity-30 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full text-center">
            ...
            <p className="mb-4 text-gray-700">Invite your friends to Cyber Hub | Empirical Training</p>
            <div className="bg-gray-100 p-3 rounded text-sm break-words mb-4">{referralLink}</div>
            <button
              onClick={handleCopy}
